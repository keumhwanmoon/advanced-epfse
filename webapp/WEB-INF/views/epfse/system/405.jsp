    ...
    <div id="MissingPage">
        <div class="MissingBox">
            <ul style="margin-left: 180px">
                <li><strong>${requestScope["ITEM.msgWrongReq"]}<%-- 잘못된 요청입니다. --%></strong></li>
            ...
            <div class="MissingBtm">
                <div class="EngTxt">
                    <dl>
                        ...
                        <dd>${requestScope["ITEM.msgEngWrongReq"]}<%-- The Web server cannot find the file or script you asked for.<br/>Please check the URL to ensure that the path is correct. --%><dd>
                    </dl>
                </div>
