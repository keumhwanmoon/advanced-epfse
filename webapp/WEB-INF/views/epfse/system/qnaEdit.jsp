      ...
      , function(objData)
        {
            ...
            $('[name="answrCtts"]').val(Base.EMPTYSTR); // 답변 초기화
        }
    );
}
...
function fnCtrlScr(strClsfy)
{
    ...
    {
        if( !gfnIsEmpty($('[name="answrCtts"]').val()) )
...
//         if ( !gfnVerifInputYn("내용", "txaCtts", MSG_INPUT_ITEM) ) return false; // 내용
    }
        ...
        <table class="boardInput01">
            ...
            <thead>
                <tr>
                    ...
                    <td>
                        <input type="text" id="txtTitleName" name="titleName" class="inputText" />
                    </td>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td colspan="2">
                        <textarea id="txaCtts" name="ctts" cols="100" rows="10" class="inputText systemQ"></textarea>
                    </td>
                </tr>
            </tbody>
        </table>
